...
(() => {
  ...
  var require_function_uncurry_this = __commonJS({
    "node_modules/core-js/internals/function-uncurry-this.js"(exports, module) {
      ...
      module.exports = bind ? function(fn2) {
        return fn2 && callBind(call2, fn2);
      } : function(fn2) {
        return fn2 && function() {
          return call2.apply(fn2, arguments);
        };
      };
    }
  });
  ...
  var require_ordinary_to_primitive = __commonJS({
    "node_modules/core-js/internals/ordinary-to-primitive.js"(exports, module) {
      ...
      module.exports = function(input, pref) {
        var fn2, val;
        if (pref === "string" && isCallable2(fn2 = input.toString) && !isObject(val = call2(fn2, input)))
          return val;
        if (isCallable2(fn2 = input.valueOf) && !isObject(val = call2(fn2, input)))
          return val;
        if (pref !== "string" && isCallable2(fn2 = input.toString) && !isObject(val = call2(fn2, input)))
          return val;
